...
CreateReconciliationComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineComponent"]({
  ...
  styles: [".applyMargin[_ngcontent-%COMP%] {\n  margin-top: 2.5rem;\n}\n\n.total[_ngcontent-%COMP%]   h4[_ngcontent-%COMP%] {\n  font-size: 18px;\n  font-weight: 600;\n  margin: 15px 0 0px;\n  padding: 10px 0px;\n}\n.total[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  font-weight: 500;\n  font-size: 16px;\n  line-height: 19px;\n  color: #929eae;\n  margin: 0px;\n  padding: 10px 0px;\n}\n\n.card-table[_ngcontent-%COMP%] {\n  border: 0.5px solid #f4f4f4;\n  box-shadow: 3px 7px 12px 0px rgba(0, 0, 0, 0.18);\n  -webkit-box-shadow: 3px 7px 12px 0px rgba(0, 0, 0, 0.18);\n  -moz-box-shadow: 3px 7px 12px 0px rgba(0, 0, 0, 0.18);\n}\n\n.btn-provide[_ngcontent-%COMP%] {\n  background-color: #dc3545;\n  color: white;\n  outline: none;\n  border: none;\n  padding: 8px 14px 8px 14px;\n  border-radius: 4px;\n  font-size: 12px;\n  width: 80px;\n}\n\n.btn-disabled[_ngcontent-%COMP%] {\n  background-color: #c5c6c7;\n  color: white;\n  outline: none;\n  border: none;\n  padding: 8px 14px 8px 14px;\n  border-radius: 4px;\n  font-size: 12px;\n  width: 80px;\n}\n\n.paging-wrapper[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  gap: 24px;\n  margin-top: 30px;\n}\n.paging-wrapper[_ngcontent-%COMP%]   .showing[_ngcontent-%COMP%] {\n  font-family: \"KumbhSans-SemiBold\", sans-serif;\n  font-size: 0.875rem;\n  color: var(--dxfe-title-color);\n}\n.paging-wrapper[_ngcontent-%COMP%]   .showing[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: var(--dxfe-primary-color);\n}\n.paging-wrapper[_ngcontent-%COMP%]     .pagination {\n  display: flex;\n  margin: 0;\n}\n.paging-wrapper[_ngcontent-%COMP%]     .pagination .page-item .page-link {\n  margin: 0 4px;\n  padding: 0;\n  width: 32px;\n  height: 32px;\n  border: 0;\n  background-color: unset;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.paging-wrapper[_ngcontent-%COMP%]     .pagination .page-item .page-link .page-number {\n  width: 100%;\n  height: 100%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  border: 1px solid #bdbdbd;\n  border-radius: 10px;\n  font-family: \"KumbhSans-SemiBold\", sans-serif;\n  font-size: 0.875rem;\n  line-height: 1.125rem;\n  color: #313131;\n}\n.paging-wrapper[_ngcontent-%COMP%]     .pagination .page-item .page-link:focus {\n  box-shadow: none;\n  outline: 0;\n}\n.paging-wrapper[_ngcontent-%COMP%]     .pagination .page-item.disabled .page-link {\n  background-color: unset;\n}\n.paging-wrapper[_ngcontent-%COMP%]     .pagination .page-item.active .page-number {\n  color: #fff;\n  background-color: var(--dxfe-primary-color);\n  box-shadow: 0px 7px 16px rgba(0, 0, 0, 0.14);\n  border: 1px solid var(--dxfe-primary-color);\n}\n.paging-wrapper[_ngcontent-%COMP%]     .pagination .page-item:not(.active):not(.disabled):hover {\n  opacity: 0.5;\n}\n\n.play-left[_ngcontent-%COMP%] {\n  color: #eceaea;\n  transform: rotate(180deg);\n  margin-right: 5px;\n}\n\n.play-right[_ngcontent-%COMP%] {\n  color: #eceaea;\n}\n\n.dropdownBox[_ngcontent-%COMP%] {\n  position: absolute;\n  width: 150px;\n  height: 48px;\n  background: #4e9aff;\n  border-radius: 8px;\n}\n\n.headButton[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 95px;\n  height: 34.2px;\n  border-radius: 8px;\n}\n\n.headButtonText[_ngcontent-%COMP%] {\n  font-family: Kumbh Sans;\n  font-size: 14px;\n  font-weight: 600;\n  line-height: 17px;\n  letter-spacing: 0em;\n  text-align: left;\n}\n\n.menu[_ngcontent-%COMP%] {\n  width: 180px;\n  filter: drop-shadow(0px 10px 20px rgba(0, 0, 0, 0.1));\n}\n\n.menu2[_ngcontent-%COMP%] {\n  width: 235px;\n  filter: drop-shadow(0px 10px 20px rgba(0, 0, 0, 0.1));\n}\n\n.more-filter-drop[_ngcontent-%COMP%] {\n  height: 46px;\n  width: 150px;\n  background: #4e9aff;\n  border-radius: 8px;\n  color: white;\n  outline: none;\n  border: none;\n}\n\n.dropdown-item[_ngcontent-%COMP%] {\n  padding: 12px 12px;\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n}\n\n.checkBox[_ngcontent-%COMP%] {\n  accent-color: #dc3545;\n  width: 20px;\n  height: 20px;\n}\n\n.dropdownFilters[_ngcontent-%COMP%] {\n  border-radius: 8px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  gap: 8px;\n  border: 1px solid #dc3545;\n}\n\n.filterFlex[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n  gap: 8px;\n  flex-wrap: wrap;\n}\n\n.btn-edit[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  width: 20px;\n}\n\np[_ngcontent-%COMP%] {\n  font-weight: 500;\n  font-size: 16px;\n  line-height: 19px;\n  color: #929eae;\n  margin: 0px;\n}\n\n.btn-cancel[_ngcontent-%COMP%] {\n  padding: 12px 24px;\n  background-color: #F8F8F8;\n  border-radius: 8px;\n  color: red;\n}\n\n.modal-content[_ngcontent-%COMP%] {\n  border: 0px;\n}\n\n  .ng-select.ng-select-multiple .ng-select-container {\n  height: 46px !important;\n  min-height: 46px;\n}\n  .ng-select.ng-select-multiple .ng-select-container .ng-value-container {\n  flex-wrap: nowrap !important;\n  overflow: hidden !important;\n  padding-top: 0 !important;\n  padding-bottom: 0 !important;\n  align-items: center;\n}\n  .ng-select.ng-select-multiple .ng-select-container .ng-value-container .ng-value {\n  display: inline-flex;\n  align-items: center;\n  white-space: nowrap;\n  max-width: 140px;\n  padding: 4px 8px;\n  margin: 0 4px 0 0;\n  font-size: 12px;\n  line-height: normal;\n}\n  .ng-select.ng-select-multiple .ng-select-container .ng-value-container .ng-value .ng-value-label {\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n  .ng-select.ng-select-multiple .ng-select-container .ng-value-container .ng-value.badge-more {\n  background-color: #6c757d;\n  cursor: default;\n}\n  .ng-select.ng-select-multiple .ng-select-container .ng-value-container .ng-input {\n  padding-top: 0;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
});
